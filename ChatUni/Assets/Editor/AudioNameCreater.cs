...
{
	private const string COMMAND_NAME = "Tools/Create Constant/Audio Name";        // コマンド名
	private const string EXPORT_PATH = "Assets/Script/Constants/AUDIO.cs"; //作成したスクリプトを保存するパス
	...
	public static void Create()
	{
		...
		EditorUtility.DisplayDialog(FILENAME, "AUDIOの作成が完了しました", "OK");
	}
